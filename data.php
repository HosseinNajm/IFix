...
<html lang="sv">
	<head>
		...
		<!--Delen width=device-widthställer 
        in sidans bredd så att den följer enhetens skärmbredd (som varierar beroende på enhet).
		...
		<link rel="shortcut icon" href="removebg-preview.png" type="image/png"/>
          <link rel="apple-touch-icon" href="removebg-preview.png" type="image/png"/>
...
<div class="container bg-dark  text-white">
			<a href="index.html"><img id="logo" src="removebg-preview.png" alt="logo_IFix"></a>
 ...
 <div>
	 ...
	 <hr style="width:50%; margin-left:25%; height:3px;border-width:0;color:red;background-color:green">
			<p class="text-center">För frågor eller för att boka tid för reparation smat realisering, fyll
				i formuläret, ring eller mejla oss.</p>
	 <br>

   <div class="row">
	   <div style="padding-left: 50px; padding-top: 60px;" class="row">
 <form style="float:left" method="post">
       <div class="form-group">
       <label>Enter Name</label>
		   <br>
       <input type="text" name="name" placeholder="Enter Name" class="form-control" size="40"/>
      </div>
      <div class="form-group">
       <label>Enter Email</label>
       <input type="text" name="email" class="form-control col" placeholder="Enter Email" />
      </div>
      <div class="form-group">
...
<div class="mp" id="googleMap" style="width:500px;height:380px; float:right;"></div>
  ...
  <a href="mailto:hossein.hasani137537@gmail.com"><i class="fa fa-envelope-o"></i></a><!---koplar gmail--->
